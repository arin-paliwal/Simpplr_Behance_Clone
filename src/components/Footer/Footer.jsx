import { behance, builtForCreatives, findTalent, social } from '../../data/footer';
    ...
    <div className="bg-[#191919] flex flex-col  text-white1 p-[5rem]">
      <div className="flex justify-between">
        ...
        <div className="flex flex-wrap gap-8 text-[1.1rem]">
          ...
          <div className="flex flex-col gap-3 w-[12rem]">
            <h3 className="font-bold mb-6">{findTalent.heading}</h3>
            {findTalent.options.map((option, index) => (
              <a href={option.route} key={index}>
                {option.name}
              </a>
            ))}
          ...
          <div className="flex flex-col gap-3 w-[12rem]">
            <h3 className="font-bold mb-6">{behance.heading}</h3>
            {behance.options.map((option, index) => (
              <a href={option.route} key={index}>
                {option.name}
              </a>
            ))}
